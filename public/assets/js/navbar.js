class CustomNavbar extends HTMLElement {
    ...
    render() {
      ...
      const showLogout = this.getAttribute('data-show-logout') === 'true';
      this.innerHTML = `
        <style>
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top">
          <div class="container-fluid">
            <a class="navbar-brand d-flex align-items-center" href="#">
              <img src="${logoUrl}" alt="Brand Logo" width="50" height="50" class="d-inline-block align-top ms-2">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
              <ul class="navbar-nav">
                ...
                ${showLogout ? '<li class="nav-item text-danger"><a class="nav-link text-danger" href="/logout">Logout</a></li>' : ''}
              </ul>
            </div>
            <div class="d-flex">
