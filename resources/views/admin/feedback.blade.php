    ...
    <body class="hold-transition sidebar-mini sidebar-collapse">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title">Feedback User</h4>
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{ {url('insert') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="gambar1" class="form-label">Gambar Produk</label>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($user as $komen)
                                        @csrf
                                            <tr>
                                                <td>{{$komen -> name}}</td>
                                                <td>{{$komen -> idUser}}</td>
                                                <td>{{$komen -> feedback}}</td>
                                                ...
                                                <td width="150">
                                                    <!--div class="btn-group d-flex justify-content-around gap-4">
                                                                        ...
                                                                        < !-- < ?php echo form_open('Jadwal/editJadwal')?> - ->
                                                                            <Form action=" url('edit') }}" method="POST">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" id="stok" value="s{$produk -> stokProduk}}" name="stok">
                                                                                </div>
                                                                                <div class="form-group">
                                                        ...
                                                        <Form action="{{ url('deletefeed') }}" method="POST">
                                                            @csrf
                                                            <button type="submit" value="{{$komen->id}}"
                                                                class="btn btn-danger btn-sm" name="idFeedback"
        ...
        <!-- </div>
            ...
            <footer class="main-footer">
                ...
                <strong
                    >Copyright &copy; 2014
                    <a href="https://adminlte.io">Nusantara Chicken</a>.</strong
                >
                All rights reserved.
            </footer>
