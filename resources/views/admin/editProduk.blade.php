                        ...
                        <Form action="{{ url('edit') }}" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama" value="{{$produk -> namaProduk}}" name="nama">
                                    </div>
                                    <div class="form-group">
                                        <label for="gambar1" class="form-label">Gambar Produk</label>
                                        <div class="container my-2">
                                            <img src="{{asset('storage/assets/images/'. $produk -> gambarProduk)}}" alt="gambar produk" class="img w-25">
                                        </div>
                                        <input type="file" class="form-control" id="gambar1" name="gambar1">
                                    </div>
                                    <!-- @f oreach ($foto as $index => $potret)
                                    @c srf
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="stokProduk" value="{{$produk -> stokProduk}}" name="stokProduk">
                                    </div>
                                    <div class="form-group">
