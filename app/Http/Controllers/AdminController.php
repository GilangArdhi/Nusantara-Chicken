...
class AdminController extends Controller
{
    public function admin(Request $request){
        ...
        $lastId += 1;
        // $id_produk = $product->first()->id; 
        // $gambar = FotoProduk::where('id_produk', $id_produk)->get();
        return view('admin.admin', ['product' => $product, 'lastId' => $lastId]);
    }
    ...
    public function insert(Request $request){
        ...
        if ($request->hasFile('gambar1')) {
            ...
            $path = 'assets/images/heros/'.$filenameGambarUtama;
        ...
        if ($idProduk != $lastId){
            $insert = Produk::create([
                ...
                'gambarProduk'=> $filenameGambarUtama,
                'stokProduk' => $stok,
                'deskripsi' => $deskripsi,
                'harga' => $harga
            ]);
    ...
    public function edit(Request $request){
        ...
        if ($request->hasFile('gambar1')) {
            //delete
            $gambar = 'assets/images/heros/' . $produk->gambar;
    ...
    public function feedback(Request $request){
        ...
        $user = DB::table('users')->join('feedback', 'feedback.idUser', '=', 'users.id')->get();
        return view('admin.feedback', ['feedback' => $feedback, 'user' => $user]);
    }

    public function dltFeedback(Request $request){
        $idFeedback = $request->idFeedback;
        $feed = UserFeedback::find($idFeedback);
        $feed->delete();
        return back()->with('message', 'Feedback berhasil dihapus');
    }
